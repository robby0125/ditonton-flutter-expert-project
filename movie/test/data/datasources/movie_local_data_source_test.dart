...
void main() {
  ...
  group('cache now playing movies', () {
    test('should call database helper to save data', () async {
      // arrange
      when(mockMovieDatabaseHelper.clearMoviesCache('now playing'))
          .thenAnswer((_) async => 1);
      ...
      // assert
      verify(mockMovieDatabaseHelper.clearMoviesCache('now playing'));
      verify(mockMovieDatabaseHelper
          .insertMovieCacheTransaction([testMovieCache], 'now playing'));
    });

    test('should return list of movies from db when data exist', () async {
      // arrange
      when(mockMovieDatabaseHelper.getCacheMovies('now playing'))
  ...
  group('cache popular movies', () {
    test('should call database helper to save data', () async {
      // arrange
      when(mockMovieDatabaseHelper.clearMoviesCache('popular'))
          .thenAnswer((_) async => 1);
      ...
      // assert
      verify(mockMovieDatabaseHelper.clearMoviesCache('popular'));
      verify(mockMovieDatabaseHelper
    ...
    test('should return list of movies from db when data exist', () async {
      // arrange
      when(mockMovieDatabaseHelper.getCacheMovies('popular'))
          .thenAnswer((_) async => [testMovieCacheMap]);
  ...
  group('cache top rated movies', () {
    test('should call database helper to save data', () async {
      // arrange
      when(mockMovieDatabaseHelper.clearMoviesCache('top rated'))
          .thenAnswer((_) async => 1);
      ...
      // assert
      verify(mockMovieDatabaseHelper.clearMoviesCache('top rated'));
      verify(mockMovieDatabaseHelper
          .insertMovieCacheTransaction([testMovieCache], 'top rated'));
    });

    test('should return list of movies from db when data exist', () async {
      // arrange
      when(mockMovieDatabaseHelper.getCacheMovies('top rated'))
          .thenAnswer((_) async => [testMovieCacheMap]);
